      ...
      <div class="modal-content">
        ...
        <form action="{{route('pagos.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" class=" form-control form-control-sm" name="orden_trabajo_id" value="{{$item->id}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txt_campo_1" class=" form-control form-control-sm" name="monto" value="{{$item->monto-$item->pendiente}}">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"  id="txt_campo_2"  class="monto form-control form-control-sm" name="monto_pagar">
                    </div>
                </div>
            </div>
